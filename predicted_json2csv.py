...
json_path = r"C:\dataset\anno_ava\stand01.json"
keyframes_path = r"C:\dataset\rawframe\stand01\\"
...
start_time = 0  # In order to write out the timestamp that you want

# Create CSV
csvFile = open(r"C:\dataset\anno_csv\predicted_ann.csv", "w+", encoding="gbk")
